...
if ($databooking > 0) {
$this->session->set_flashdata('pesan', '<div class="alert alert-danger alertmessage" role="alert">Masih Ada booking buku sebelumnya yang belum diambil.<br> Ambil Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali </div>');
redirect(base_url());
}
...
public function hapusbooking()
	{
		...
		$this->ModelBooking->deleteData([
			'id_buku' => $id_buku, 
			'email_user' => $this->session->userdata('email')], 'temp');
